...
garden_harvest%>%
  ...
  group_by(variety)%>%
  mutate(length2 = fct_reorder(vegetable, length_variety))%>%
  summarize(string_length = length2, variety = variety)
...
```
  ...
  It looks like more events happen in the October-November timeframe than in Novemeber-December or in December-January. 
